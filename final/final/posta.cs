...
namespace final
{
	public partial class posta : Form
	{
		...
		private void button1_Click_1(object sender, EventArgs e)
		{
			...
			MySqlCommand cmd = new MySqlCommand("SELECT*FROM posta WHERE Baslik='" + baslk + "'", baglan);
		...
		private void posta_Load(object sender, EventArgs e)
		{
